...
Focus Areas:
  - Mobile & Web Apps (React Native, Flet, FastAPI)
...
### 📌 ApplyPulse
> **Job Application Tracker** — Save jobs in one click, manage pipeline, track analytics, and export data.  
**Tech:** FastAPI, MongoDB, JWT, Chrome Extension, Tailwind  
🔗 [Live](https://applypulse.onrender.com) · [Repo](https://github.com/jawadahmadliaqat-dot/ApplyPulse)

---

### 📌 Renderora
> **Cloud-Native Animation Studio** — Write Manim/Matplotlib code in browser, render videos & plots online.  
**Tech:** FastAPI, Manim, Matplotlib, Docker  
🔗 [Live](https://renderora.onrender.com) · [Repo](https://github.com/jawadahmadliaqat-dot/Renderora)

---

### 📌 CineFetch Pro
> **Android Video Downloader** — Fast, lightweight, privacy-focused downloader with automation workflows.  
**Tech:** Python, Flet, Android, FFmpeg  
🔗 [Repo](https://github.com/jawadahmadliaqat-dot/CineFetch-Pro)

---

### 📌 Profile Repository
> **Main Showcase** — Stats, trophies, contribution graph, and GitHub activity.  
**Tech:** GitHub Actions, Markdown, SVG Animations  
🔗 [Profile](https://github.com/jawadahmadliaqat-dot)
